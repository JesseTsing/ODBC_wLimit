...
#define PLUGIN_NAME "EL ODBC"
#define PLUGIN_NAME_AFL "EL Q ODBC"
#define VENDOR_NAME "EL"
#define PLUGIN_VERSION 11868
#define PLUGIN_ID PIDCODE( 'E', 'L', 'Q', 'O' )
...
{ 
	...
	if( ( pn->nReason & REASON_DATABASE_LOADED ) )
	{
		...
		if( g_oData.m_iRefreshInterval > 0 )
		{
			SetTimer( g_oData.m_hAmiBrokerWnd, MY_TIMER_ID, g_oData.m_iRefreshInterval * 1000 , TIMERPROC(TimerFunc) );
		}
		else
		{
